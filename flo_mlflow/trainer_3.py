...
if __name__ == "__main__":
    ...
    list_estimator = [linear_model.LinearRegression(), linear_model.Ridge(),linear_model.Lasso(),linear_model.ElasticNet(),linear_model.SGDRegressor()]


    for estim in list_estimator:
        trainer3 = Trainer_V3(experiment_name = 'test_experiment')
        trainer3.set_train_test()
        trainer3.set_pipeline(estimator = estim)
        trainer3.run()
        trainer3.evaluate()
        trainer3.save_model(estim.__class__.__name__)
